...
def get_random_offset():
    return (-1 * (random.random() < 0.5)) * random.random() * 12;
...
def distort_image(image):
    ...
    for points in lines:
        ...
        cv2.line(distorted,(x1,y1),(x2,y2),(255,255,255),2)
...
cv2.imwrite("undistort2.png", distort_image(image))